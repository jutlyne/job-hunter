...
class Employer extends Model
{
    ...
    {
        return ($this->thumbnail) ? Storage::disk()->url($this->avatar) : asset('img/default_company.jpg');
    }

    public function getThumbnailUrlAttribute()
    {
        return ($this->thumbnail) ? Storage::disk()->url($this->thumbnail) : asset('img/default_company.jpg');
    }
