...
mix.js('resources/js/moment.js', 'public/js')
  ...
  .sass('resources/sass/user/pages/employer/show.scss', 'public/css/user/pages/employer')
  .sass('resources/sass/user/pages/employer/index.scss', 'public/css/user/pages/employer')
