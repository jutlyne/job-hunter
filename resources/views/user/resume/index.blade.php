                        ...
                        <div class="padding-left">
                            <div class="manage-jobs-sec">
                                <div class="border-title">
                                    <h3>Candidates Dashboard</h3><a href="#" title=""><i class="la la-plus"></i> Add
                                        Education</a>
                                </div>
                                <div class="edu-history-sec">
                                    <div class="edu-history">
                                        ...
                                        <ul class="action_job">
                                            ...
                                            <li><span>Delete</span><a href="#" title=""><i class="la la-trash-o"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="edu-history">
                                ...
                                <div class="border-title">
                                    <h3>Work Experience</h3><a href="#" title=""><i class="la la-plus"></i> Add
                                        Experience</a>
                                </div>
                                <div class="edu-history-sec">
                                ...
                                <div class="border-title">
                                    <h3>Portfolio</h3><a href="#" title=""><i class="la la-plus"></i> Add Portfolio</a>
                                </div>
                                <div class="mini-portfolio">
                                    <div class="mp-row">
                                        <div class="mp-col">
                                            <div class="mportolio"><img src="images/resource/p1.jpg" alt="" /><a
                                        ...
                                        <div class="mp-col">
                                            <div class="mportolio"><img src="images/resource/p2.jpg" alt="" /><a
                                                    href="#" title=""><i class="la la-search"></i></a></div>
                                            <ul class="action_job">
                                                <li><span>Edit</span><a href="#" title=""><i class="la la-pencil"></i></a>
                                                </li>
                                        ...
                                        <div class="mp-col">
                                            <div class="mportolio"><img src="images/resource/p3.jpg" alt="" /><a
                                                    href="#" title=""><i class="la la-search"></i></a></div>
                                            <ul class="action_job">
                                                <li><span>Edit</span><a href="#" title=""><i class="la la-pencil"></i></a>
                                                </li>
                                        ...
                                        <div class="mp-col">
                                            <div class="mportolio"><img src="images/resource/p4.jpg" alt="" /><a
                                                    href="#" title=""><i class="la la-search"></i></a></div>
                                            <ul class="action_job">
                                                <li><span>Edit</span><a href="#" title=""><i class="la la-pencil"></i></a>
                                                </li>
                                ...
                                <div class="border-title">
                                    <h3>Professional Skills</h3><a href="#" title=""><i class="la la-plus"></i> Add
                                        Skills</a>
                                </div>
